  ...
  if(good_count + neutral_count + bad_count != 0){
    return(
      <table>
        ...
        <StatisticsLine count={calculateAverage(good_count, neutral_count, bad_count)} text="average"/>
        <StatisticsLine count={calcPosPercentage(good_count, neutral_count, bad_count)} text="positive"/>
        </tbody>
      </table>
    )
  }
