...
describe('total likes ', () => {
  ...
  test('get author with the most blogs', () => {
    const author_with_most_blogs = listHelper.authorWithMostBlogs(multiple_blogs)
    assert.strictEqual(author_with_most_blogs.author, 'jorma')
  })
  test('get author with the most likes', () => {
    const author_with_most_likes = listHelper.mostLikes(multiple_blogs)
    assert.strictEqual(author_with_most_likes.likes, 9)
  })
